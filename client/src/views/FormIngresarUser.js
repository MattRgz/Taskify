...
const FormIngresarUser = () => {
  ...
  const [titleButon ,setTitleButon ] = useState()
  ...
  useEffect(() => {
    id? setTitleButon("Editar") : setTitleButon("Registrarse")
  }, []);
  ...
  return (
    <div>
      {
        id? <NavBarLogged/> : <NavBarUnLogged/>
      }
          ...
          <div>
            ...
            <div>
              ...
              <div className='centrar' style={{margin:'20%'}}>
                <Button  style={{backgroundColor:'black',borderColor:'black',marginRight:'15px'}} variant="success" type="submit">{titleButon}</Button>
                {id ?  <Button  style={{backgroundColor:'black',color:'white',borderColor:'black'}} variant="danger"> <Link to={"/user"} style={{backgroundColor:'black',color:'white', textDecoration:'none'}}>Cancelar</Link></Button >
